    ...
    const faqs = [
        {
            ...
            answer: "CV Colibri Dannata Success adalah perusahaan yang bergerak di bidang atap, menyediakan berbagai jenis atap berkualitas untuk kebutuhan konstruksi Anda."
        },
        {
            id: "faq2",
            question: "Bagaimana cara memesan produk?",
            answer: "Anda dapat melakukan pemesanan melalui WhatsApp dengan menghubungi kami langsung. Informasi kontak tersedia di website kami."
        },
        {
            id: "faq3",
            question: "Apa saja produk yang tersedia?",
            answer: "Kami menyediakan berbagai jenis atap, termasuk atap metal, atap bitumen, dan material atap lainnya yang dapat disesuaikan dengan kebutuhan proyek Anda."
        },
        {
            id: "faq4",
            question: "Apakah CV Colibri Dannata Success memiliki layanan konsultasi?",
            answer: "Ya, kami menyediakan layanan konsultasi untuk membantu Anda memilih jenis atap yang sesuai dengan kebutuhan konstruksi Anda."
        }
    ];
            ...
            <div className="lg:flex gap-10 text-foreground">
                <div className="flex flex-col self-center flex-1 lg:mb-0 mb-5 lg:text-left text-center">
                    ...
                    <p className="font-light mt-2 text-sm md:text-base">
                        Temukan jawaban dari pertanyaan yang sering diajukan langsung di sini untuk informasi tentang produk, pemesanan, dan layanan konsultasi CV Colibri Dannata Success.
                    </p>
                </div>
