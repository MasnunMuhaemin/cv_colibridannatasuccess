...
const products = [
  ...
  {
    id: 2,
    image: "/images/OWEN/Classicsuper/asianred.jpg",
    name: "Classic Super Asian Red",
  },
  {
    id: 3,
      ...
      <div className="border border-secondary rounded-lg p-4 mt-2 pb-20 relative">
        <header className="text-black absolute left-4 top-4 flex items-start space-x-4">
          <img
            ...
            alt="Logo Owens Corning"
            className="w-20 md:w-28 h-14"
          />
          <div>
            <h4 className="text-md font-semibold">Atap Owen Corning</h4>
            <p className="text-xs">
              Atap berkualitas tinggi dengan daya tahan terhadap cuaca ekstrem.
            </p>
          </div>
        </header>
