...
const products = [
  ...
  { id: 6, image: "/images/FIRESCREEN/Terracosta.jpg", name: "Terra Costa" },
];
    ...
    <div className="p-4">
      <div className="border border-secondary rounded-lg p-4 mt-2 pb-20 relative">
        <div className="text-black absolute left-4 top-4 flex items-start space-x-4">
          ...
          />
          <div>
            <h4 className="text-md font-semibold">Atap Firescreen</h4>
            <p className="text-xs">
              Atap Firescreen berkualitas tinggi dengan daya tahan terhadap
              cuaca ekstrem.
            </p>
          </div>
        </div>
