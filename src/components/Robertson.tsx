...
const products = [
  ...
  { id: 3, image: "/images/Robertson/Robertsontop.jpg", name: "Robertson Top Hatch" },
  { id: 4, image: "/images/Robertson/Robetson1040.jpg", name: "Robertson 1040" }
];
    ...
    <div className="font1 p-4">
      <div className="border border-secondary rounded-lg p-4 mt-2 pb-20 relative">
        <div className="text-black absolute left-4 top-4 flex items-start space-x-4">
          ...
          />
          <div>
            <h4 className="text-md font-semibold">Atap Robertson</h4>
            <p className="text-xs">
