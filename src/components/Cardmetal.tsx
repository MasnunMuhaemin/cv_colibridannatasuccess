...
const products = [
  {
    id: 1,
    image: "/images/Primasupreme/AtapGelombang/JayaDeck.jpg",
    name: "Jaya Deck 700/800 Color",
  },
  {
    id: 2,
    image: "/images/Primasupreme/AtapGelombang/Jayadeck2.jpg",
    name: "Jaya Deck 750/765 Color",
  },
  {
    id: 3,
    image: "/images/Primasupreme/AtapGelombang/Jayadeck3.jpg",
    name: "Jaya Deck 960",
  },
  {
    id: 4,
    image: "/images/Primasupreme/AtapGelombang/JayaDeck4.jpg",
    name: "Jaya Deck 1020",
  },
  {
    id: 5,
    image: "/images/Primasupreme/GentengMetal/Inti.jpg",
    name: "Inti 3x4",
  },
  {
    id: 6,
    image: "/images/Primasupreme/GentengMetal/Minimalis.jpg",
    name: "Minimalis 2x2",
  },
  {
    id: 7,
    image: "/images/Primasupreme/GentengMetal/MinimalisTrendyColor.jpg",
    name: "Minimalis Trendi Color",
  },
  {
    id: 8,
    image: "/images/Primasupreme/GentengMetal/MinimalisTrendyColor2.jpg",
    name: "Minimalis Trendi Color",
  },
];
    ...
    <div className="font1 text-black p-4 relative mt-20">
      ...
      <div className="border border-secondary rounded-lg p-4 mt-2 pb-20 relative">
        <div className="absolute left-4 top-4 flex items-start space-x-4">
          <img
            src="/images/Primasupreme/logo.png"
          ...
          <div>
            ...
            <p className="text-xs">
              Atap Prima Roof berkualitas tinggi dengan daya tahan terhadap
              cuaca ekstrem.
            </p>
          </div>
        </div>
