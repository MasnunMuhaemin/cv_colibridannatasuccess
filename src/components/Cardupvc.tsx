...
const products = [
  {
    id: 1,
    image: "/images/ALDERON/Alderonaksesoris.jpg",
    name: "Aksesoris Wather Seal & NOK",
  },
  {
    id: 2,
    image: "/images/ALDERON/Alderoncorugatted.jpg",
    name: "Alderon Twin Wall Corrugated",
  },
  { id: 3, image: "/images/ALDERON/Alderoneco.jpg", name: "Alderon Eco" },
  {
    id: 4,
    image: "/images/ALDERON/Alderonsingle.jpg",
    name: "Alderon RS Single Wall Corrugated",
  },
  {
    id: 5,
    image: "/images/ALDERON/Alderontwin.jpg",
    name: "Alderon Lite Twin Wall Corrugated",
  },
];
      ...
      <div className="border border-secondary rounded-lg p-4 mt-2 pb-20 relative">
        <div className="absolute left-4 top-4 flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-xs">
              Atap Alderon berkualitas tinggi dengan daya tahan terhadap cuaca
              ekstrem.
            </p>
          </div>
        </div>
